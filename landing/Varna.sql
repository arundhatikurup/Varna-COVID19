...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2020 at 09:50 PM
...
INSERT INTO `total_patient_details` (`Cell_Phone`, `Name`, `Referral_number`, `Cough`, `Dry_cough`, `Wet_cough`, `Sore_Throat`, `Shortness_of_Breath`, `Loss of Taste`, `Loss of Smell`, `Fever reducing medicine in past 24 hours`, `Someone in household diagnosed with Covid-19`, `Shelter name assigned`, `Room`, `Bed`, `Temperature`, `Risk_factor`) VALUES
('2134056707', 'Dawn Lee', 309123, 1, 1, 0, 0, 1, 0, 1, 1, 0, 'Springview Shelter', 773, 1104, 101.3, 'Mid'),
('3256987412', 'Drew Pooli', 113333, 0, 0, 1, 0, 1, 0, 1, 0, 1, 'Palsoei', 283, 405, 99.7, 'Mid'),
('6842697153', 'Rosy Chicken', 115599, 0, 0, 1, 0, 1, 1, 1, 1, 1, 'Eotyriuhj', 289, 413, 103.5, 'High'),
('6987412359', 'Henry Looo', 112233, 1, 0, 0, 1, 1, 1, 1, 1, 1, 'Ignasius', 281, 401, 98.7, 'High'),
('95175538526', 'Paras Sharma', 115573, 0, 1, 0, 1, 0, 0, 1, 0, 0, 'Eyeoiu', 289, 413, 100.4, 'Mid'),
('9518476235', 'Jijnasa Sahu', 113333, 0, 0, 1, 0, 0, 1, 0, 1, 0, 'Poeuytr', 283, 405, 98.7, 'Low'),
('9638527415', 'Arundhati Kurup', 115599, 0, 0, 0, 0, 0, 0, 0, 0, 0, 'Pliuytr', 289, 413, 98.7, 'Low'),
('9638529635', 'M. Arundhati', 115573, 1, 0, 0, 1, 0, 0, 0, 0, 0, 'Pwokmdb', 289, 413, 99.8, 'Mid'),
('9876543215', 'Akshat Kurup', 115573, 0, 0, 1, 1, 1, 0, 1, 1, 0, 'Werloiuyt', 289, 413, 102.7, 'High');
